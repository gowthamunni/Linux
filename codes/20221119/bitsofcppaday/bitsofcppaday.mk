...
WorkspacePath          :=/home/unnigowtham/project/linux/codes/20221119
ProjectPath            :=/home/unnigowtham/project/linux/codes/20221119/bitsofcppaday
...
../build-$(ConfigurationName)/bitsofcppaday/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/bitsofcppaday/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/unnigowtham/project/linux/codes/20221119/bitsofcppaday/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
